...
class PageViewTabBarSixthPage extends StatelessWidget {
  const PageViewTabBarSixthPage({super.key, required this.config, this.bankAccounts = const []});

  final PageViewTabBarSixthPageConfig config;
