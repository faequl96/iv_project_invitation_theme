...
class PageViewTabBarFourthDifferentLocationPage extends StatelessWidget {
  const PageViewTabBarFourthDifferentLocationPage({
    super.key,
    required this.config,
    required this.receptionEvent,
  });

  final PageViewTabBarFourthDifferentLocationPageConfig config;
