...
class PageViewTabBarConfigs {
  const PageViewTabBarConfigs({
  ...
  final PageViewTabBarCoverPageConfig coverPageConfig;
  final PageViewTabBarFirstPageConfig firstPageConfig;
  final PageViewTabBarSecondPageConfig secondPageConfig;
  final PageViewTabBarThirdPageConfig thirdPageConfig;
  final PageViewTabBarThirdDifferentLocationPageConfig thirdDifferentLocationPageConfig;
  final PageViewTabBarFourthPageConfig fourthPageConfig;
  final PageViewTabBarFourthDifferentLocationPageConfig fourthDifferentLocationPageConfig;
  final PageViewTabBarFifthPageConfig fifthPageConfig;
  final PageViewTabBarSixthPageConfig sixthPageConfig;
  final PageViewTabBarSeventhPageConfig seventhPageConfig;
  final PageViewTabBarEighthPageConfig eighthPageConfig;
}

class PageViewTabBarTabConfig {
  const PageViewTabBarTabConfig({
...
class PageViewTabBarCoverPageConfig {
  const PageViewTabBarCoverPageConfig({
...
class PageViewTabBarFirstPageConfig {
  const PageViewTabBarFirstPageConfig({
    this.foreground,
    this.background,
...
class PageViewTabBarSecondPageConfig {
  const PageViewTabBarSecondPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarThirdPageConfig {
  const PageViewTabBarThirdPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarThirdDifferentLocationPageConfig {
  const PageViewTabBarThirdDifferentLocationPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarFourthPageConfig {
  const PageViewTabBarFourthPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarFourthDifferentLocationPageConfig {
  const PageViewTabBarFourthDifferentLocationPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarFifthPageConfig {
  const PageViewTabBarFifthPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarSixthPageConfig {
  const PageViewTabBarSixthPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarSeventhPageConfig {
  const PageViewTabBarSeventhPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
...
class PageViewTabBarEighthPageConfig {
  const PageViewTabBarEighthPageConfig({
    this.foreground,
    this.background,
    required this.useBackdropBlurOnScaffold,
    required this.firstGradientScaffoldColor,
