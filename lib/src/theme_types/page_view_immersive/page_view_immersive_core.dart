...
class PageViewImmersiveCore extends StatefulWidget {
  const PageViewImmersiveCore({
    super.key,
  ...
  @override
  State<PageViewImmersiveCore> createState() => _PageViewImmersiveCoreState();
}

class _PageViewImmersiveCoreState extends State<PageViewImmersiveCore> {
