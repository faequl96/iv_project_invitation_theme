    ...
    return PageViewBased(
      configs: PageViewBasedConfigs(
        tabConfig: TabConfig(
          ...
          titleInactiveColor: Colors.red.shade200,
        ...
        coverPageConfig: PageViewBasedCoverPageConfig(
          ...
          countdownOddBorderColor: Colors.red.shade200,
        ...
        firstPageConfig: PageViewBasedFirstPageConfig(
          ...
          firstGradientBackgroundColor: ColorConverter.darken(Colors.red.shade700, 60),
          ...
          generalTextColor: ColorConverter.darken(Colors.red.shade700, 30),
        ...
        secondPageConfig: PageViewBasedSecondPageConfig(
          ...
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          generalTextColor: ColorConverter.darken(Colors.red.shade500, 5),
          brideDividingBorderWidth: 1,
          brideImageBorderWidth: 1,
          brideDividingLineWidth: 1,
          brideDividingBorderColor: Colors.red.shade400,
          brideImageFrameColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .3),
          brideImageFrameBorderColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .8),
          brideDividingLineColor: Colors.red.shade400,
          brideNameTextColor: ColorConverter.darken(Colors.red.shade700),
          brideFatherNameTextColor: ColorConverter.darken(Colors.red.shade700),
          brideMotherNameTextColor: ColorConverter.darken(Colors.red.shade700),
          groomDividingBorderWidth: 1,
          groomImageBorderWidth: 1,
          groomDividingLineWidth: 1,
          groomDividingBorderColor: Colors.red.shade400,
          groomImageFrameColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .3),
          groomImageFrameBorderColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .8),
          groomDividingLineColor: Colors.red.shade400,
          groomNameTextColor: ColorConverter.darken(Colors.red.shade700),
          groomFatherNameTextColor: ColorConverter.darken(Colors.red.shade700),
          groomMotherNameTextColor: ColorConverter.darken(Colors.red.shade700),
        ),
        thirdPageConfig: PageViewBasedThirdPageConfig(
          useBackdropBlurOnScaffold: true,
          firstGradientBackgroundColor: ColorConverter.darken(Colors.red.shade700, 60).withValues(alpha: .0),
          ...
          glassEffectOpacity: .5,
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          contractTitleColor: ColorConverter.darken(Colors.red.shade700),
          contractBaseTextColor: ColorConverter.darken(Colors.red.shade700),
          receptionTitleColor: ColorConverter.darken(Colors.red.shade700),
          receptionBaseTextColor: ColorConverter.darken(Colors.red.shade700),
          dividingLineWidth: 1,
          dividingLineColor: Colors.red.shade300,
          ...
          contractCountdownOddBorderColor: Colors.red.shade500,
          contractCountdownEvenBorderColor: Colors.red.shade500,
          contractCountdownNumberColor: ColorConverter.darken(Colors.red.shade700),
          contractCountdownUnitColor: ColorConverter.darken(Colors.red.shade700),
          ...
          receptionCountdownOddBorderColor: Colors.red.shade500,
          receptionCountdownEvenBorderColor: Colors.red.shade500,
          receptionCountdownNumberColor: ColorConverter.darken(Colors.red.shade700),
          receptionCountdownUnitColor: ColorConverter.darken(Colors.red.shade700),
          useLightningEffectOnCountdown: true,
        ),
        thirdDifferentLocationPageConfig: PageViewBasedThirdDifferentLocationPageConfig(
          ...
          glassEffectOpacity: .5,
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          dateTimeIconColor: ColorConverter.darken(Colors.red.shade700),
          dateTimeBaseTextColor: ColorConverter.darken(Colors.red.shade700),
          countdownBorderWidth: 1,
          countdownOddColor: Colors.white.withValues(alpha: .3),
          countdownEvenColor: Colors.white.withValues(alpha: .3),
          countdownOddBorderColor: Colors.red.shade500,
          countdownEvenBorderColor: Colors.red.shade500,
          countdownNumberColor: ColorConverter.darken(Colors.red.shade700),
          countdownUnitColor: ColorConverter.darken(Colors.red.shade700),
          useLightningEffectOnCountdown: false,
          dividingLineWidth: 1,
          dividingLineColor: Colors.red.shade300,
          placeIconColor: ColorConverter.darken(Colors.red.shade700),
          placeBaseTextColor: ColorConverter.darken(Colors.red.shade700),
          addressTextColor: ColorConverter.darken(Colors.red.shade700),
          mapsBorderColor: Colors.white.withValues(alpha: .7),
          getDirectionsButtonColor: ColorConverter.darken(Colors.red.shade500).withValues(alpha: .8),
        ...
        fifthPageConfig: PageViewBasedFifthPageConfig(
          ...
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          dividingLineWidth: 1,
          dividingVerticalLineColor: ColorConverter.darken(Colors.red.shade200),
          dividingHorizontalLineColor: ColorConverter.darken(Colors.red.shade200),
          seeMoreButtonColor: ColorConverter.darken(Colors.red.shade500).withValues(alpha: .8),
          ...
          bottomSheetBackgroundColor: ColorConverter.darken(Colors.red.shade900, 50).withValues(alpha: .8),
        ...
        sixthPageConfig: PageViewBasedSixthPageConfig(
          ...
          glassEffectOpacity: .5,
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          introductionTextColor: ColorConverter.darken(Colors.red.shade700),
          ...
          bankBorderWidth: 1,
          bankTextColor: ColorConverter.darken(Colors.red.shade700),
          bankCopyBaseColor: ColorConverter.darken(Colors.red.shade500),
        ),
        seventhPageConfig: PageViewBasedSeventhPageConfig(
          ...
          fieldFillColor: Colors.red.shade700.withValues(alpha: .2),
          ...
          submitButtonColor: ColorConverter.darken(Colors.red.shade500).withValues(alpha: .8),
          ...
          rsvpNameTextColor: ColorConverter.darken(Colors.red.shade700),
          rsvpTimeAgoTextColor: Colors.grey.shade800,
          rsvpNameInstanceTextColor: Colors.grey.shade600,
          rsvpAttendanceTextColorLighten: 20,
          rsvpMessageTextColor: ColorConverter.darken(Colors.red.shade600),
          seeMoreButtonColor: ColorConverter.darken(Colors.red.shade500).withValues(alpha: .8),
          seeMoreButtonLabelColor: Colors.white,
          seeMoreButtonBorderWidth: 1.5,
          seeMoreButtonBorderColor: Colors.white,
        ...
        eighthPageConfig: PageViewBasedEighthPageConfig(
          ...
          glassEffectOpacity: .6,
          titlePageColor: ColorConverter.darken(Colors.red.shade900, 20),
          closingTextColor: ColorConverter.darken(Colors.red.shade700),
          brideGroomNameColor: ColorConverter.darken(Colors.red.shade700),
