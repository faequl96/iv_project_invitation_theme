    ...
    return PageViewBased(
      configs: PageViewBasedConfigs(
        ...
        secondPageConfig: PageViewBasedSecondPageConfig(
          ...
          brideImageBaseColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .8),
          ...
          groomImageBaseColor: ColorConverter.darken(Colors.red.shade400, 5).withValues(alpha: .8),
