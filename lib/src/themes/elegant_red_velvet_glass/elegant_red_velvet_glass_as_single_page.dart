...
class ElegantRedVelvetGlassAsSinglePage extends StatelessWidget {
  const ElegantRedVelvetGlassAsSinglePage({
    super.key,
    this.initialPage = 0,
    ...
    return PageViewBasedAsSinglePage(
      configs: PageViewBasedConfigs(
        ...
        thirdDifferentLocationPageConfig: PageViewBasedThirdDifferentLocationPageConfig(
          ...
          dividingLineWidth: 1,
          dividingLineColor: ColorConverter.darken(Colors.red.shade500),
        ...
        fourthDifferentLocationPageConfig: PageViewBasedFourthDifferentLocationPageConfig(
          ...
          countdownBorderWidth: 1,
          countdownOddColor: ColorConverter.lighten(Colors.red.shade50, 40).withValues(alpha: .6),
          countdownEvenColor: ColorConverter.lighten(Colors.red.shade50, 40).withValues(alpha: .6),
