    ...
    return PageViewBased(
      configs: PageViewBasedConfigs(
        ...
        particleSphere: ParticleSphereConfig(
          colors: [
            ColorConverter.darken(Colors.lightGreenAccent, 5),
            Colors.white,
            ColorConverter.darken(Colors.green.shade700, 40),
          ],
        ),
        ...
        secondPageConfig: PageViewBasedSecondPageConfig(
          ...
          brideImageBaseColor: ColorConverter.darken(Colors.green.shade400, 5).withValues(alpha: .8),
          ...
          groomImageBaseColor: ColorConverter.darken(Colors.green.shade400, 5).withValues(alpha: .8),
