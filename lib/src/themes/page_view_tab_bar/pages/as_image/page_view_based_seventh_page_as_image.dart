...
class PageViewTabBarSeventhPageAsImage extends StatelessWidget {
  const PageViewTabBarSeventhPageAsImage({super.key, required this.config});

  final PageViewTabBarSeventhPageConfig config;
