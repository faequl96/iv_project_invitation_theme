...
class PageViewTabBarFirstPageAsImage extends StatelessWidget {
  const PageViewTabBarFirstPageAsImage({super.key, required this.config, required this.general});

  final PageViewTabBarFirstPageConfig config;
