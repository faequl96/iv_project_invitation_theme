...
class PageViewTabBarThirdDifferentLocationPage extends StatelessWidget {
  const PageViewTabBarThirdDifferentLocationPage({
    super.key,
    required this.config,
    required this.contractEvent,
  });

  final PageViewTabBarThirdDifferentLocationPageConfig config;
