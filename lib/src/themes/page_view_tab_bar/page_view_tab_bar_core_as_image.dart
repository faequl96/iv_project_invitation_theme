...
class PageViewTabBarCoreAsImage extends StatefulWidget {
  const PageViewTabBarCoreAsImage({
    super.key,
    this.initialPage = 0,
    this.wrapper,
    this.backgrounds,
  ...
  @override
  State<PageViewTabBarCoreAsImage> createState() => _PageViewTabBarCoreAsImageState();
}

class _PageViewTabBarCoreAsImageState extends State<PageViewTabBarCoreAsImage>
