...
class EveryPageIsWrappedFifthPage extends StatelessWidget {
  const EveryPageIsWrappedFifthPage({super.key, required this.viewType, this.galleries, this.gallery});
