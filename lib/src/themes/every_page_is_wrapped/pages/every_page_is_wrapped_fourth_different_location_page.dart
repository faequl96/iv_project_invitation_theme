...
class EveryPageIsWrappedFourthDifferentLocationPage extends StatelessWidget {
  const EveryPageIsWrappedFourthDifferentLocationPage({super.key, required this.receptionEvent});
