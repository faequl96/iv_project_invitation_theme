    ...
    return PageViewBased(
      configs: PageViewBasedConfigs(
        ...
        globalBackgroundBuilder: () => BubbleBackground(
          backgroundColor: ColorConverter.darken(Colors.blue.shade100, 10).withValues(alpha: .6),
        ...
        firstPageConfig: PageViewBasedFirstPageConfig(
          ...
          generalTextColor: Colors.blue.shade600,
          firstSubScaffoldColor: Colors.white.withValues(alpha: .7),
        ...
        secondPageConfig: PageViewBasedSecondPageConfig(
          ...
          titlePageColor: ColorConverter.darken(Colors.blue.shade900, 30),
        ...
        thirdPageConfig: PageViewBasedThirdPageConfig(
          ...
          glassEffectOpacity: .5,
          titlePageColor: ColorConverter.darken(Colors.blue.shade900, 30),
          contractTitleColor: Colors.blue.shade700,
          contractBaseTextColor: Colors.blue.shade700,
          ...
          contractCountdownOddColor: Colors.white.withValues(alpha: .5),
          contractCountdownEvenColor: Colors.white.withValues(alpha: .5),
          contractCountdownOddBorderColor: Colors.blue.shade500,
          contractCountdownEvenBorderColor: Colors.blue.shade500,
          contractCountdownNumberColor: Colors.blue.shade700,
          contractCountdownUnitColor: Colors.blue.shade700,
        ...
        sixthPageConfig: PageViewBasedSixthPageConfig(
          ...
          secondGradientBackgroundColor: ColorConverter.darken(Colors.blue.shade900, 40),
          firstGradientScaffoldColor: Colors.white.withValues(alpha: .3),
          secondGradientScaffoldColor: Colors.white.withValues(alpha: .75),
          stopsGradientScaffoldColor: [.2, .6],
          scaffoldBorder: GradientBoxBorder(
            width: 1.5,
            gradient: LinearGradient(
          ...
          glassEffectOpacity: .5,
          titlePageColor: ColorConverter.darken(Colors.blue.shade900, 30),
          introductionTextColor: Colors.blue.shade600,
          introductionColor: Colors.white.withValues(alpha: .5),
          introductionBorderColor: Colors.blue.shade200,
          introductionBorderWidth: 1,
          bankColor: Colors.white.withValues(alpha: .5),
          bankBorderColor: Colors.blue.shade300,
          bankBorderWidth: 1,
          bankTextColor: Colors.blue.shade600,
        ...
        seventhPageConfig: PageViewBasedSeventhPageConfig(
          ...
          firstGradientBackgroundColor: ColorConverter.darken(Colors.blue.shade900, 40),
          secondGradientBackgroundColor: ColorConverter.darken(Colors.blue.shade900, 40).withValues(alpha: 0),
          firstGradientScaffoldColor: Colors.white.withValues(alpha: .65),
