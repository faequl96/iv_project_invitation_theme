...
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/glass_core.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_cover_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_eighth_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_fifth_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_first_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_fourth_different_location_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_fourth_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_second_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_seventh_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_sixth_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_third_different_location_page.dart';
import 'package:iv_project_invitation_theme/src/theme_family/glass_theme/pages/glass_third_page.dart';
import 'package:iv_project_model/iv_project_model.dart';

class GlassTheme extends StatefulWidget {
  const GlassTheme({
    super.key,
  ...
  @override
  State<GlassTheme> createState() => _GlassThemeState();
}

class _GlassThemeState extends State<GlassTheme> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return GlassCore(
      ...
      pages: [
        ...
        GlassFirstPage(config: widget.configs.firstPageConfig, general: invitationData.general),
        GlassSecondPage(
        ...
        if (invitationData.contractEvent.mapsUrl == invitationData.receptionEvent.mapsUrl) ...[
          ...
          GlassThirdDifferentLocationPage(
            config: widget.configs.thirdDifferentLocationPageConfig,
            contractEvent: invitationData.contractEvent,
          ),
          GlassFourthDifferentLocationPage(
