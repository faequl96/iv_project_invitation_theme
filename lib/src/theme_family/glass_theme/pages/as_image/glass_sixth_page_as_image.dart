...
class GlassSixthPageAsImage extends StatelessWidget {
  const GlassSixthPageAsImage({super.key, required this.config, this.bankAccounts = const []});

  final GlassSixthPageConfig config;
