...
class GlassFifthPageAsImage extends StatelessWidget {
  const GlassFifthPageAsImage({super.key, required this.config, this.gallery});

  final GlassFifthPageConfig config;
