...
class GlassFourthPageAsImage extends StatelessWidget {
  const GlassFourthPageAsImage({super.key, required this.config, required this.receptionEvent});

  final GlassFourthPageConfig config;
