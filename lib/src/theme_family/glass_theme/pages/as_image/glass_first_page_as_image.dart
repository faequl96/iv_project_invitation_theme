...
class GlassFirstPageAsImage extends StatelessWidget {
  const GlassFirstPageAsImage({super.key, required this.config, required this.general});

  final GlassFirstPageConfig config;
