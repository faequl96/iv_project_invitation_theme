...
class GlassFourthDifferentLocationPage extends StatelessWidget {
  const GlassFourthDifferentLocationPage({
    super.key,
    required this.config,
    required this.receptionEvent,
  });

  final GlassFourthDifferentLocationPageConfig config;
