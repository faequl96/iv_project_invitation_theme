...
class GlassCore extends StatefulWidget {
  const GlassCore({
    super.key,
  ...
  @override
  State<GlassCore> createState() => _GlassCoreState();
}

class _GlassCoreState extends State<GlassCore> with SingleTickerProviderStateMixin {
