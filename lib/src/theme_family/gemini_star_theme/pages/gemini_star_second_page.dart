...
class GeminiStarSecondPage extends StatefulWidget {
  const GeminiStarSecondPage({
    super.key,
  ...
  final GeminiStarSecondPageConfig config;
  final ViewType viewType;
  final File? brideImage;
  final BridegroomResponse bride;

  @override
  State<GeminiStarSecondPage> createState() => _GeminiStarSecondPageState();
}

class _GeminiStarSecondPageState extends State<GeminiStarSecondPage> {
  Widget? _cachedImage;
  ...
  void _buildCachedImage() {
    if (widget.viewType == .preview && widget.brideImage != null) {
      _cachedImage = Image.file(widget.brideImage!, fit: .cover);
    } else if (widget.viewType == .example) {
      _cachedImage = Image.asset(
        widget.bride.imageUrl,
        fit: .cover,
        package: 'iv_project_invitation_theme',
      );
    } else {
      _cachedImage = Image.network(widget.bride.imageUrl, fit: .cover);
    }
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildBrideGroomText(
                        frontTitle: widget.bride.frontTitle,
                        fullName: widget.bride.fullName,
                        backTitle: widget.bride.backTitle,
                      ...
                      _buildFatherMotherText(
                        isFather: true,
                        frontTitle: widget.bride.fatherFrontTitle,
                        name: widget.bride.fatherName,
                        backTitle: widget.bride.fatherBackTitle,
                      ...
                      _buildFatherMotherText(
                        isFather: false,
                        frontTitle: widget.bride.motherFrontTitle,
                        name: widget.bride.motherName,
                        backTitle: widget.bride.motherBackTitle,
                ...
                Column(
                  ...
                  children: [
                    FadeAndSlideTransition(
                      ...
                      slideFrom: .left,
                      child: Text(
                        langCode == 'en' ? 'The Bride' : 'Pengantin Wanita',
                        style: AppFonts.inter(
