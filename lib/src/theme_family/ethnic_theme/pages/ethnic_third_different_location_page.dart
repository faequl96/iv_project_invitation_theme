...
class EthnicThirdDifferentLocationPage extends StatelessWidget {
  const EthnicThirdDifferentLocationPage({
    super.key,
    required this.config,
    required this.contractEvent,
  });

  final EthnicThirdDifferentLocationPageConfig config;
