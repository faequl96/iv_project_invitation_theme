...
class EthnicFifthPageAsImage extends StatelessWidget {
  const EthnicFifthPageAsImage({super.key, required this.config, this.gallery});

  final EthnicFifthPageConfig config;
