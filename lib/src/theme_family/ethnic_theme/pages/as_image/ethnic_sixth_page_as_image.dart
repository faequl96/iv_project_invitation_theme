...
class EthnicSixthPageAsImage extends StatelessWidget {
  const EthnicSixthPageAsImage({super.key, required this.config, this.bankAccounts = const []});

  final EthnicSixthPageConfig config;
