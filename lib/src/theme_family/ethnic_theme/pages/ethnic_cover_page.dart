...
class EthnicCoverPage extends StatefulWidget {
  const EthnicCoverPage({
    super.key,
  ...
  final EthnicCoverPageConfig config;
  ...
  @override
  State<EthnicCoverPage> createState() => _EthnicCoverPageState();
}

class _EthnicCoverPageState extends State<EthnicCoverPage> {
  Widget? _cachedImage;
