...
class EthnicFirstPage extends StatelessWidget {
  const EthnicFirstPage({super.key, required this.config, required this.general});

  final EthnicFirstPageConfig config;
