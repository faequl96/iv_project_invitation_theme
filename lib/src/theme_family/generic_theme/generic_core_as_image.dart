...
class GenericCoreAsImage extends StatefulWidget {
  const GenericCoreAsImage({
    super.key,
    this.initialPage = 0,
    this.wrapper,
    this.backgrounds,
  ...
  @override
  State<GenericCoreAsImage> createState() => _GenericCoreAsImageState();
}

class _GenericCoreAsImageState extends State<GenericCoreAsImage>
