...
class RedVelvetGlass {
  ...
  static GenericConfigs get configs => GenericConfigs(
    ...
    globalBackgroundsBuilder: () => [
      BubbleBackground(
        backgroundColor: ColorUtil.darken(Colors.red.shade100, 20).withValues(alpha: .6),
        bubbleColor1: ColorUtil.darken(Colors.redAccent, 15),
        bubbleColor2: ColorUtil.darken(Colors.red.shade900, 40),
        bubbleColor3: ColorUtil.darken(Colors.red.shade700, 40),
        bubbleColor4: ColorUtil.darken(Colors.red.shade400, 5),
        bubbleColor5: ColorUtil.darken(Colors.redAccent, 5),
        noAnimate: false,
      ),
    ],
    particleSphere: .circle(
      circleParticleVariations: [
        CircleParticle(color: ColorUtil.darken(Colors.redAccent, 5)),
    ...
    firstPageConfig: GenericFirstPageConfig(
      ...
      generalTextColor: ColorUtil.darken(Colors.red.shade700, 30),
    ...
    secondPageConfig: GenericSecondPageConfig(
      ...
      brideMotherNameTextColor: ColorUtil.darken(Colors.red.shade700),
    ...
    thirdPageConfig: GenericThirdPageConfig(
      ...
      contractBaseTextColor: ColorUtil.darken(Colors.red.shade700),
      receptionTitleColor: ColorUtil.darken(Colors.red.shade700),
      receptionBaseTextColor: ColorUtil.darken(Colors.red.shade700),
      dividingLineWidth: 1,
      ...
      contractCountdownNumberColor: ColorUtil.darken(Colors.red.shade700),
      contractCountdownUnitColor: ColorUtil.darken(Colors.red.shade700),
    ...
    thirdDifferentLocationPageConfig: GenericThirdDifferentLocationPageConfig(
      ...
      dateTimeBaseTextColor: ColorUtil.darken(Colors.red.shade700),
      countdownBorderWidth: 1,
      ...
      placeBaseTextColor: ColorUtil.darken(Colors.red.shade700),
      addressTextColor: ColorUtil.darken(Colors.red.shade700),
      mapsBorderColor: Colors.white.withValues(alpha: .7),
      getDirectionsButtonColor: ColorUtil.darken(Colors.red.shade500).withValues(alpha: .8),
    ...
    fourthDifferentLocationPageConfig: GenericFourthDifferentLocationPageConfig(
      ...
      countdownBorderWidth: 1,
      countdownOddColor: ColorUtil.lighten(Colors.red.shade50, 40).withValues(alpha: .6),
      countdownEvenColor: ColorUtil.lighten(Colors.red.shade50, 40).withValues(alpha: .6),
    ...
    fifthPageConfig: GenericFifthPageConfig(
      ...
      titlePageColor: ColorUtil.darken(Colors.red.shade900, 20),
      dividingLineWidth: 1,
      dividingVerticalLineColor: ColorUtil.darken(Colors.red.shade200),
      dividingHorizontalLineColor: ColorUtil.darken(Colors.red.shade200),
      seeMoreButtonColor: ColorUtil.darken(Colors.red.shade500).withValues(alpha: .8),
    ...
    eighthPageConfig: GenericEighthPageConfig(
      ...
      brideGroomNameColor: ColorUtil.darken(Colors.red.shade700),
