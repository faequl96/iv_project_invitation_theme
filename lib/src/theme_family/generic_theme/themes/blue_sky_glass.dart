...
class BlueSkyGlass {
  ...
  static GenericConfigs get configs => GenericConfigs(
    ...
    globalBackgroundsBuilder: () => [
      BubbleBackground(
        backgroundColor: ColorUtil.darken(Colors.blue.shade100, 20).withValues(alpha: .6),
        bubbleColor1: ColorUtil.darken(Colors.lightBlueAccent, 15),
        bubbleColor2: ColorUtil.darken(Colors.blue.shade900, 40),
        bubbleColor3: ColorUtil.darken(Colors.blue.shade700, 40),
        bubbleColor4: ColorUtil.darken(Colors.blue.shade400, 5),
        bubbleColor5: ColorUtil.darken(Colors.lightBlueAccent, 5),
        noAnimate: false,
      ),
      // SizedBox(
      //   width: Screen.width,
      ...
      //       colors: [Colors.lightBlueAccent, Colors.white, ColorUtil.darken(Colors.blue.shade700, 40)],
      //     ),
      //   ),
      // ),
    ],
    ...
    firstPageConfig: GenericFirstPageConfig(
      ...
      generalTextColor: ColorUtil.darken(Colors.blue.shade700, 30),
    ...
    secondPageConfig: GenericSecondPageConfig(
      ...
      brideMotherNameTextColor: ColorUtil.darken(Colors.blue.shade700),
    ...
    thirdPageConfig: GenericThirdPageConfig(
      ...
      contractBaseTextColor: ColorUtil.darken(Colors.blue.shade700),
      receptionTitleColor: ColorUtil.darken(Colors.blue.shade700),
      receptionBaseTextColor: ColorUtil.darken(Colors.blue.shade700),
      dividingLineWidth: 1,
      ...
      contractCountdownNumberColor: ColorUtil.darken(Colors.blue.shade700),
      contractCountdownUnitColor: ColorUtil.darken(Colors.blue.shade700),
    ...
    thirdDifferentLocationPageConfig: GenericThirdDifferentLocationPageConfig(
      ...
      dateTimeBaseTextColor: ColorUtil.darken(Colors.blue.shade700),
      countdownBorderWidth: 1,
      ...
      placeBaseTextColor: ColorUtil.darken(Colors.blue.shade700),
      addressTextColor: ColorUtil.darken(Colors.blue.shade700),
      mapsBorderColor: Colors.white.withValues(alpha: .7),
      getDirectionsButtonColor: ColorUtil.darken(Colors.blue.shade500).withValues(alpha: .8),
    ...
    fourthDifferentLocationPageConfig: GenericFourthDifferentLocationPageConfig(
      ...
      countdownBorderWidth: 1,
      countdownOddColor: ColorUtil.lighten(Colors.blue.shade50, 40).withValues(alpha: .6),
      countdownEvenColor: ColorUtil.lighten(Colors.blue.shade50, 40).withValues(alpha: .6),
    ...
    fifthPageConfig: GenericFifthPageConfig(
      ...
      titlePageColor: ColorUtil.darken(Colors.blue.shade900, 20),
      dividingLineWidth: 1,
      dividingVerticalLineColor: ColorUtil.darken(Colors.blue.shade200),
      dividingHorizontalLineColor: ColorUtil.darken(Colors.blue.shade200),
      seeMoreButtonColor: ColorUtil.darken(Colors.blue.shade500).withValues(alpha: .8),
    ...
    eighthPageConfig: GenericEighthPageConfig(
      ...
      brideGroomNameColor: ColorUtil.darken(Colors.blue.shade700),
