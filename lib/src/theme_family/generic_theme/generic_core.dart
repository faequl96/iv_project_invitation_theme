...
class GenericCore extends StatefulWidget {
  const GenericCore({
    super.key,
  ...
  @override
  State<GenericCore> createState() => _GenericCoreState();
}

class _GenericCoreState extends State<GenericCore> with SingleTickerProviderStateMixin {
