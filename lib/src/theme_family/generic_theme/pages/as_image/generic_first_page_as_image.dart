...
class GenericFirstPageAsImage extends StatelessWidget {
  const GenericFirstPageAsImage({super.key, required this.config, required this.general});

  final GenericFirstPageConfig config;
