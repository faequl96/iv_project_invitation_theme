...
class GenericSixthPageAsImage extends StatelessWidget {
  const GenericSixthPageAsImage({super.key, required this.config, this.bankAccounts = const []});

  final GenericSixthPageConfig config;
