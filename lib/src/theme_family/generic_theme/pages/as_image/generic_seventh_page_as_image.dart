...
class GenericSeventhPageAsImage extends StatelessWidget {
  const GenericSeventhPageAsImage({super.key, required this.config});

  final GenericSeventhPageConfig config;
