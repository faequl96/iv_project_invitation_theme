...
class GenericFifthPageAsImage extends StatelessWidget {
  const GenericFifthPageAsImage({super.key, required this.config, this.gallery});

  final GenericFifthPageConfig config;
