...
class EthnicSeventhPageAsImage extends StatelessWidget {
  const EthnicSeventhPageAsImage({super.key, required this.config});

  final EthnicSeventhPageConfig config;
