    ...
    _invitation = InvitationResponse(
      ...
      invitationData: InvitationDataResponse(
        ...
        bride: const BridegroomResponse(
          id: 1,
          nickname: 'Rahma',
          fullName: 'Rahma Nur Istiqomah, M.Biomed',
          fatherName: 'Bagyo Trisno Ngulandoro, S.T',
          motherName: 'Peni Lestari, S.E',
        ),
        groom: const BridegroomResponse(
          id: 2,
          nickname: 'Faiq',
          fullName: 'Faiq Ulul Fahmi, S.Pd',
          fatherName: 'Syamsuddin, S.Pd',
          motherName: 'Sa\'idah',
        ),
